...
public class Products{
	...
	@Embedded
	@AttributeOverride(name="prod_id", column=@Column(name="prod_id"))
	@AttributeOverride(name="quan_in_stock", column=@Column(name="quan_in_stock"))
	@AttributeOverride(name="sales", column=@Column(name="sales"))
	private Inventory inventory;
	@Embedded
	@AttributeOverride(name="id_category", column=@Column(name="id_category"))
	@AttributeOverride(name="categoryname", column=@Column(name="categoryname"))
