...
public class DocOrderlines{
	...
	public DocOrders getOrders(){
		return orders;
	}
	public void setOrders(DocOrders value) {
		this.orders = value;
	}
	public DocProducts getProducts(){
		return products;
	}
	public void setProducts(DocProducts value) {
		this.products = value;
	}
